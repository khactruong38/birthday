const contentLetterSrart_actived = "Chúc mừng sinh nhật Giang nhé!" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật bạn Giang! Chúc mừng sinh nhật đặc biệt của bạn vào ngày 16/9! Ngày này không chỉ là một dịp để kỷ niệm thêm một năm tuổi mới mà còn là cơ hội để bắt đầu một hành trình mới đầy hứng thú và thành công. Hy vọng rằng bạn sẽ có một ngày sinh nhật tràn đầy niềm vui, hạnh phúc và bất ngờ. Cùng với sự ủng hộ và tình yêu của gia đình, bạn sẽ vượt qua mọi thách thức và đạt được những ước mơ lớn lao trong cuộc sống. Chúc bạn có một năm mới đầy năng lượng, sức khỏe dồi dào và thành công trong mọi lĩnh vực bạn theo đuổi. Sinh nhật vui vẻ, Giang! 🎂🎉🥳" //Nội dung của bức thư
